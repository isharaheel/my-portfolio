...
export default function Intro(params) {
    return(
        <>
<Box sx={{width:{xs:'80%',sm:'80%',md:'80%',lg:'80%'},height:'auto',margin:{xs:'100px auto',sm:'none',md:'100px auto',lg:'150px auto'},display:'flex',flexDirection:{xs:'column',sm:'column',md:'row',lg:'row '},
...
<Typography sx={{color:'var(--color)',fontSize:{xs:'15px',sm:'14px',md:'15px',lg:"23px"},fontFamily:'serif'}}>Passionate Full-Stack Web Developer based in Faisalabad.
