...
export default function Intro(params) {
    return(
        <>
<Box sx={{width:{xs:'100%',sm:'100%',md:'80%',lg:'80%'},height:'auto',margin:{xs:'100px auto',sm:'none',md:'100px auto',lg:'150px auto'},display:'flex',flexDirection:{xs:'column',sm:'column',md:'row',lg:'row '},
gap:'80px',padding:'20px',alignItems:{xs:'left',sm:'center',md:"left",lg:'center'}
}}>
 <Box sx={{width:{xs:'90%',sm:'90%',md:"100%",lg:'70%'},height:'100%',display:'flex',flexDirection:'column',gap:'20px'}}>
